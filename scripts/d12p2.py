...
class Node:
    ...
    def neighbors(self, map):
        ...
        for i in range(0, 360, 90):
            ...
            # Had to reverse this since we're searching in reverse
...
def main():
    ...
    a_dists = [dist for state, dist in closed.items() if state.height == 0]
    print(min(a_dists))
